...
public:
	...
	static auto Dot(const Vector3& lhs, const Vector3& rhs) -> const float; //스칼라. 벡터방향의 크기
	static auto Cross(const Vector3& lhs, const Vector3& rhs) -> const Vector3; //수직벡터
...
inline Vector3 operator*(const float& lhs, const Vector3& rhs) { return rhs * lhs; } //scalar * veector가 안되기 때문에 만든 inline 함수